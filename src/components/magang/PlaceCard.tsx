...
export default function PlaceCard({
  ...
  return (
    <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden break-inside-avoid p-5">
      ...
      <div className="flex items-start gap-4 mb-4">
        {/* Logo with shadow */}
        <div className="w-16 h-16 rounded-xl overflow-hidden flex-shrink-0 bg-gray-100 dark:bg-gray-700 shadow-md">
          <Image
            src={companyLogo}
            alt={companyName}
            width={64}
