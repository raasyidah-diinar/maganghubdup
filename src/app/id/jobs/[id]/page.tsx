...
const JobDetailSkeleton = () => (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-900 flex flex-col items-center justify-center p-4">
        ...
        {/* Optional: Subtle background placeholders to maintain layout feel */}
        <div className="fixed inset-0 pointer-events-none opacity-[0.03] dark:opacity-[0.05] z-0 overflow-hidden px-8 pt-32">
