...
export default function ArticlePage() {
    ...
    const post = BLOG_POSTS.find(p => p.slug === "psikologi-warna-ui-design") || BLOG_POSTS[2];
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none">
                            <div className="text-gray-700 dark:text-gray-300 leading-[1.8] space-y-6">
                                <p>Warna memiliki kekuatan untuk membangkitkan emosi dan mempengaruhi perilaku tanpa satu kata pun diucapkan. Dalam desain UI, pemahaman tentang psikologi warna sangat krusial.</p>
                                <h3>Arti di Balik Warna Oranye</h3>
                                <p>Oranye sering dikaitkan dengan energi, antusiasme, dan kreativitas. Ini adalah warna yang ramah yang terasa lebih mudah didekati daripada merah yang agresif.</p>
                                <h3>Kontras dan Aksesibilitas</h3>
                                <p>Memilih warna bukan hanya tentang estetika. Pastikan teks Anda tetap terbaca dengan kontras yang cukup, memenuhi standar WCAG untuk inklusivitas semua pengguna.</p>
                            </div>
                        </div>
