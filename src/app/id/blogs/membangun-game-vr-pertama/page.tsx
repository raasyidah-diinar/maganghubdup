...
export default function ArticlePage() {
    ...
    const post = BLOG_POSTS.find(p => p.slug === "membangun-game-vr-pertama") || BLOG_POSTS[1];
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none">
                            <div className="text-gray-700 dark:text-gray-300 leading-[1.8] space-y-6">
                                <p>Virtual Reality (VR) bukan lagi sekadar masa depan; ia ada di sini sekarang. Dengan Unity, Anda dapat mulai membangun pengalaman imersif Anda sendiri.</p>
                                <h3>Menyiapkan Environment Unity untuk VR</h3>
                                <p>Langkah pertama adalah memastikan Anda memiliki Toolkit Interaksi XR yang benar. Ini adalah fondasi untuk semua interaksi VR di Unity.</p>
                                <h3>Membangun Dunia Pertama Anda</h3>
                                <p>Mulailah dengan sesuatu yang sederhana - sebuah ruangan dengan beberapa objek yang dapat berinteraksi. Pelajari cara menggunakan controller untuk mengambil dan memindahkan objek.</p>
                                <p>Fokus pada kenyamanan pengguna adalah kunci dalam pengembangan VR. Pastikan frame rate tetap tinggi dan pergerakan kamera halus untuk menghindari mabuk darat digital.</p>
                            </div>
                        </div>
