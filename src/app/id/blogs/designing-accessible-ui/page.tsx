...
export default function ArticlePage() {
    ...
    const post = BLOG_POSTS.find(p => p.slug === "designing-accessible-ui") || BLOG_POSTS[6];
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none">
                            <div className="text-gray-700 dark:text-gray-300 leading-[1.8] space-y-6">
                                <p>Desain adalah tentang inklusivitas. Web harus dapat diakses oleh semua orang, apa pun kemampuan mereka.</p>
                                <h3>Gunakan Semantik HTML</h3>
                                <p>Jangan hanya menggunakan `div`. Gunakan tag yang benar seperti `nav`, `main`, dan `section` untuk membantu alat pembaca layar (screen reader) memahami struktur halaman Anda.</p>
                                <h3>Warna Bukan Satu-satunya Komunikator</h3>
                                <p>Jangan pernah menyampaikan informasi hanya melalui warna. Berikan label atau pola tambahan sehingga pengguna dengan gangguan penglihatan warna tetap bisa mendapatkan pesan Anda.</p>
                            </div>
                        </div>
