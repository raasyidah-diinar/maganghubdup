...
export default function ArticlePage() {
    ...
    const post = BLOG_POSTS.find(p => p.slug === "persiapan-pkl-smk-rpl") || BLOG_POSTS[3];
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none">
                            <div className="text-gray-700 dark:text-gray-300 leading-[1.8] space-y-6">
                                <p>PKL adalah jembatan pertama Anda menuju dunia profesional. Sebagai siswa RPL, ekspektasinya cukup tinggi.</p>
                                <h3>Asah Hard Skill Anda</h3>
                                <p>Pastikan Anda memahami dasar-dasar bahasa pemrograman yang diminta perusahaan, apakah itu JavaScript, Python, atau Java. Mempunyai portofolio proyek sederhana sangat membantu.</p>
                                <h3>Pentingnya Soft Skill</h3>
                                <p>Komunikasi dan kemampuan bekerja sama seringkali lebih dinilai daripada sekadar kemampuan coding teknis. Pelajari cara bertanya dengan benar dan menerima feedback dengan terbuka.</p>
                            </div>
                        </div>
