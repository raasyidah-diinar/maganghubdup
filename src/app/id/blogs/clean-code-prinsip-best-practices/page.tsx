...
export default function ArticlePage() {
    ...
    const post = BLOG_POSTS.find(p => p.slug === "clean-code-prinsip-best-practices") || BLOG_POSTS[5];
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        ...
                        <div className="prose prose-lg dark:prose-invert max-w-none">
                            <div className="text-gray-700 dark:text-gray-300 leading-[1.8] space-y-6">
                                <p>Menulis kode adalah satu hal, menulis kode yang bisa dibaca orang lain adalah hal lain. Clean code adalah investasi jangka panjang.</p>
                                <h3>Penamaan yang Berarti</h3>
                                <p>Gunakan nama variabel yang menjelaskan niatnya secara eksplisit. Hindari singkatan yang membingungkan atau kata-kata yang terlalu umum.</p>
                                <h3>Fungsi Kecil dan Fokus</h3>
                                <p>Sebuah fungsi idealnya hanya melakukan satu hal. Ini membuatnya lebih mudah diuji, dipahami, dan digunakan kembali.</p>
                            </div>
                        </div>
