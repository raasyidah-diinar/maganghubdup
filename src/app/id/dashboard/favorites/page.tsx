...
export default function FavoritesPage() {
    ...
    const tabs = [
        ...
        { id: "vacancies", label: "vacancies", icon: <Briefcase size={18} /> },
    ...
    const renderContent = () => {
        ...
        if (activeTab === "all" || activeTab === "vacancies") {
            // Using the first two jobs for favorites mock
    ...
    return (
        <div className="flex h-screen bg-[#F8FAFC] dark:bg-gray-900 text-[#1E293B] dark:text-gray-100">
